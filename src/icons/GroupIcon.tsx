...
export default ({ fillColor, width, height }: IconProps) =>
   <svg xmlns="http://www.w3.org/2000/svg" width={width ?? 24} height={height ?? 24} viewBox="0 0 24 24">
      <g data-name="Group User">
         <g data-name="&lt;Group&gt;">
            <circle cx="12" cy="8.5" r="3" fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round"
            ...
            <path fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round" strokeLinejoin="round"
                  ...
                  data-name="&lt;Path&gt;"/>
            <g data-name="&lt;Group&gt;">
               <circle cx="4.5" cy="7.5" r="2" fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round"
                       strokeLinejoin="round" data-name="&lt;Path&gt;"/>
               <path fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round" strokeLinejoin="round"
            ...
            <g data-name="&lt;Group&gt;">
               <circle cx="19.5" cy="7.5" r="2" fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round"
                       strokeLinejoin="round" data-name="&lt;Path&gt;"/>
               <path fill="none" stroke={fillColor ?? '#000'} strokeLinecap="round" strokeLinejoin="round"
