      ...
      <div className='mobile-notifications'>
         ...
         <div className='mobile-notifications__content'>
            <Notification
               ...
               userPhoto={'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Z2lybCUyMGZhY2V8ZW58MHx8MHx8&w=1000&q=80'}
            />
            <Notification
