      ...
      <div className="comments-section">
         <div className="comments-section__write-comment">
            <div className="comments-section__write-comment__user-photo">
               <img
                  src={
                     'https://scontent.fias1-1.fna.fbcdn.net/v/t1.6435-9/131986095_1595640257304818_7572429008707616586_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=263ZILrQ_rQAX83f7s3&_nc_ht=scontent.fias1-1.fna&oh=00_AT94VYVn_-E7Zm8jAa-hs2DbklOeg5dEfNu-jjyQF1X-ug&oe=626B4D69'
                  }
                  alt="userPhoto"
               />
>>>>>>> 630584ace912d45ec1d8854914fe0da79ec13ef6
            </div>
