   ...
   return (
      <div className="mobile-settings">
         <div className="mobile-settings__header">
            ...
            <p className="mobile-settings__header__username">William</p>
         </div>
         <div className="mobile-settings__content">
            ...
            <div
               className="mobile-settings__content__log-out"
               onClick={() => {
            ...
            >
               <LogoutIcon />
               <p className="mobile-settings__content__log-out__name">Log out</p>
            </div>
         </div>
      </div>
   )
